...
VALUES
    ...
    (900760, '交易开关', 'campus:mine-trade-config:query', 2, 9, 900000, 'mine-trade-config', 'ep:switch-button', 'campus/base/index', 'CampusMineTradeConfig', 0, b'1', b'1', b'1', 'campus', NOW(), 'campus', NOW(), b'0'),
...
VALUES
    ...
    (900751, '分类新增', 'campus:home-category:create', 3, 1, 900750, '', '', '', NULL, 0, b'1', b'1', b'1', 'campus', NOW(), 'campus', NOW(), b'0'),
    (900752, '分类修改', 'campus:home-category:update', 3, 2, 900750, '', '', '', NULL, 0, b'1', b'1', b'1', 'campus', NOW(), 'campus', NOW(), b'0'),
    (900753, '分类删除', 'campus:home-category:delete', 3, 3, 900750, '', '', '', NULL, 0, b'1', b'1', b'1', 'campus', NOW(), 'campus', NOW(), b'0'),
    (900761, '交易开关修改', 'campus:mine-trade-config:update', 3, 1, 900760, '', '', '', NULL, 0, b'1', b'1', b'1', 'campus', NOW(), 'campus', NOW(), b'0'),
