...
public class CampusResourceRegistry {
    ...
    private static final Map<String, CampusResourceMeta> RESOURCES = Arrays.asList(
            ...
            meta("school", "campus_school_catalog",
                    ...
                    set("status", "city", "district"),
                    set("name", "province", "city")),
            meta("home-category", "campus_home_category",
                    set("category_key", "title", "channel", "icon_url", "publish_type", "enabled",
                            "icon_visible", "title_visible", "sort", "tenant_id", "creator", "updater"),
                    set("enabled", "channel", "tenant_id"),
                    set("category_key", "title")),
            meta("mine-trade-config", "campus_mine_trade_config",
                    set("config_name", "enabled", "published_enabled", "sold_enabled", "bought_enabled",
                            "pending_payment_enabled", "paid_enabled", "tenant_id", "creator", "updater"),
                    set("tenant_id"),
                    set("config_name")),
            ...
            meta("post", "campus_post",
                    set("title", "content", "price", "original_price", "location", "merchant_address",
                            "merchant_location_name", "merchant_latitude", "merchant_longitude", "trade_mode", "visible_range",
                            "stock_total", "stock_available", "sold_count", "sale_status",
                            "status", "tenant_id", "updater"),
                    set("user_id", "tenant_id", "type", "channel", "status", "sale_status", "school_name", "campus_name"),
                    set("title", "content", "location", "merchant_address", "merchant_location_name")),
            ...
            meta("comment-report", "campus_post_comment_report",
                    set("status", "result_note", "updater"),
                    set("post_id", "comment_id", "reporter_user_id", "tenant_id", "status"),
                    set("reason", "detail", "result_note")),
            meta("contact-request", "campus_contact_request",
                    set("status", "result_note", "updater"),
                    set("post_id", "requester_user_id", "target_user_id", "tenant_id", "status"),
                    set("post_title", "requester_nickname", "requester_mobile", "target_nickname",
                            "target_mobile", "message", "result_note"))
