...
public interface CampusPostService {
    ...
    CampusPostCommentRespVO setCommentLike(Long commentId, Long userId, boolean active);

    void deleteComment(Long commentId, Long userId);

    void reportComment(Long commentId, Long userId, CampusPostCommentReportReqVO reqVO);
