...
```text
/www/server/panel/vhost/nginx/campus-platform-8088.conf
```
...
```text
http://121.43.83.21:8088/admin-api/
```

后端原始 API：

```text
http://121.43.83.21:48080
```
...
80 端口保持原业务不变
8088 端口给校园后台管理端使用
48080 端口是后端服务端口，一般给 nginx 或调试使用
```
