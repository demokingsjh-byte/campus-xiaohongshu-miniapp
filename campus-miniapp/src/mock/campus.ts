...
export const campusChannels = ['推荐', '二手', '互助', '表白', '拼车', '探店', '失物', '社团', '兼职'];
...
export const campusPosts: CampusPost[] = [
  ...
  { id: 2051, tenantId: 201, channel: '表白', type: 'confession', title: 'TO：每天在图书馆三楼学习的你', content: '其实已经注意你很久了。希望下次在饮水机旁遇见时，我能鼓起勇气和你打个招呼。', author: '匿名用户', avatarText: '匿', school: '吉首大学', time: '36分钟前', tags: ['匿名', '图书馆'], likes: 48, comments: 9, coverColor: '#FCEAF0', coverEmoji: '💌', coverLabel: '校园表白', height: 'medium' },
  { id: 2052, tenantId: 201, channel: '表白', type: 'confession', title: 'TO：一起参加迎新晚会的学长', content: '谢谢你在我紧张的时候递来的那瓶水。希望我们还能在校园里再次见面。', author: '匿名用户', avatarText: '匿', school: '吉首大学', time: '1小时前', tags: ['迎新晚会', '心意'], likes: 31, comments: 6, coverColor: '#FFF1E8', coverEmoji: '💌', coverLabel: '校园表白', height: 'short' },
  { id: 2053, tenantId: 201, channel: '兼职', type: 'job', title: '校内奶茶店周末兼职', content: '负责点单和打包，每周至少到岗两天，有经验优先。', author: '北门茶铺', avatarText: '茶', school: '吉首大学', campusName: '吉首校区', time: '12分钟前', price: '18/时', location: '北门商业街', tags: ['周末兼职', '日结'], likes: 19, comments: 5, coverColor: '#EAF8ED', coverEmoji: '🧋', coverLabel: '周末可排班', height: 'short' },
  { id: 2054, tenantId: 201, channel: '兼职', type: 'job', title: '招晚自习资料整理助理', content: '在图书馆整理电子资料，时间灵活，做完结算。', author: '勤工助学中心', avatarText: '勤', school: '吉首大学', campusName: '吉首校区', time: '38分钟前', price: '120/天', location: '图书馆', tags: ['校内兼职', '时间灵活'], likes: 27, comments: 8, coverColor: '#EDF3FF', coverEmoji: '💻', coverLabel: '今晚可开始', height: 'short' },
  ...
  { id: 2151, tenantId: 202, channel: '表白', type: 'confession', title: 'TO：总在操场跑步的女生', content: '你每次跑完步都会认真拉伸，这个小细节让我觉得你特别可爱。祝你每天都有好心情。', author: '匿名用户', avatarText: '匿', school: '长沙学院', time: '2小时前', tags: ['操场', '匿名'], likes: 26, comments: 4, coverColor: '#FCEAF0', coverEmoji: '💌', coverLabel: '校园表白', height: 'medium' },
];
...
export const campusPublishTypes: CampusPublishType[] = [
  ...
  { key: 'confession', title: '表白墙', desc: '把想说的话告诉 TA', icon: '💌' },
  { key: 'job', title: '兼职信息', desc: '校内岗位、周末兼职', icon: '🧰' },
];
